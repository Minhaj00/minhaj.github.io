...
<section class="bg-primary mb-5">
  <article>
    <div class="text-center text-white py-5">
      <h3 class="display-3">+91 1234567890</h3>
   ...
   <div class="container">
    ...
    <div class="row mb-5">
      <div class="col-lg-4 col-md-4 col-12 mb-2">
       ...
       <div class="col-lg-4 col-md-4 col-12">
        <img src="image/img6.jpg" class="img-fluid">
      </div>
       <div class="col-lg-4 col-md-4 col-12">
        <img src="image/img2.jpg" class="img-fluid">
      </div>
...
<section class="bg-primary mb-5">
  <article>
    <div class="text-center text-white py-5">
      <h3 class="display-3">want to join</h3>
...
<section>
  <div class="container">
    <h1 class="text-center text-capitalize mt-5">contact us</h1>
    <hr class="w-25 mx-auto mb-5 ">
